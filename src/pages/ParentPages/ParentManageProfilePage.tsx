...
import { ManageProfileMenu } from '../ClientPages/ManageProfilePage/ManageProfile.enum';
import { Profile, Security, UploadAvatar } from '../ClientPages/ManageProfilePage/Components';
...
export default ParentManageProfilePage;
